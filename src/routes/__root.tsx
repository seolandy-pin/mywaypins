  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">This pin doesn't exist on our map.</p>
        <div className="mt-6">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MyWayPins" },
      { name: "description", content: "Discover travel YouTube videos pinned to real places. Google Maps meets YouTube." },
      { property: "og:title", content: "MyWayPins" },
      { property: "og:description", content: "Explore travel videos on an interactive world map." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "MyWayPins" },
      { name: "twitter:description", content: "Discover travel YouTube videos pinned to real places." },
    ],
    links: [{ rel: "stylesheet", href: appCss }, { rel: "icon", href: "/favicon.svg", type: "image/svg+xml" }, { rel: "manifest", href: "/manifest.webmanifest" }, { rel: "preconnect", href: "https://fonts.googleapis.com" }, { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Space+Grotesk:wght@500;700&family=Caveat:wght@500;700&display=swap" }],
  }),
